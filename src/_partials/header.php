        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-end flex-grow-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fs-5 me-3 text-light fw-semibold" aria-current="page" href="<?php BASE_PROJET?>./index.php#tarifs">Nos tarifs</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 justify-content-end flex-grow-1 pe-3">
                    <?php if (empty($_SESSION)) : ?>
                        <li class="nav-item">
                            <a id="fondVert" class="btn fw-bold border-2 me-3 text-light" role="button" href="<?php BASE_PROJET?>./connexion.php">Se connecter</a>
                        </li>
                        <li class="nav-item">
                            <a id="fondVert" class="btn fw-bold border-2 text-light" role="button" href="<?php BASE_PROJET?>./creation-de-compte.php">Créer un compte</a>
                        </li>
                    <?php else : ?>
                        <?php if (isset($_SESSION['pseudo_client'])) : ?>
                            <ul class="nav nav-pills">
                                <li class="nav-item dropdown">
                                    <a id="fondVert" class="nav-link dropdown-toggle fw-semibold text-light" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><i class="bi bi-person-circle me-2"></i><?= $pseudo_client ?></a>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li class="nav-item">
                                            <a class="dropdown-item fw-bold text-center text-success" role="button" href="<?php BASE_PROJET?>./commandes.php"><i class="bi bi-bag-check me-2"></i></i>Mes commandes</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
